...
template <int N>
static inline std::array<double, N> require_1d_fixed_f64(py::array_t<double, py::array::c_style> a,
                                                         const char* name) {
  auto b = a.request();
  if (b.ndim != 1 || b.shape[0] != N) {
    throw std::runtime_error(std::string(name) + " must be a 1D float64 array of length " +
                             std::to_string(N));
  }
...
static inline std::vector<double> vec_from_1d_f64(py::array_t<double, py::array::c_style> a,
                                                  const char* name) {
  auto b = a.request();
  if (b.ndim != 1) {
...
PYBIND11_MODULE(pysuperansac, m) {
  ...
  py::class_<superansac::LocalOptimizationSettings>(m, "LocalOptimizationSettings")
      ...
      .def_readwrite("sample_size_multiplier",
                     &superansac::LocalOptimizationSettings::sampleSizeMultiplier)
      .def_readwrite("spatial_coherence_weight",
                     &superansac::LocalOptimizationSettings::spatialCoherenceWeight);
  ...
  py::class_<superansac::NeighborhoodSettings>(m, "NeighborhoodSettings")
      ...
      .def_readwrite("neighborhood_grid_density",
                     &superansac::NeighborhoodSettings::neighborhoodGridDensity)
      .def_readwrite("nearest_neighbor_number",
                     &superansac::NeighborhoodSettings::nearestNeighborNumber);
  ...
  py::class_<superansac::DegensacSettings>(m, "DegensacSettings")
      ...
      .def_readwrite("inner_ransac_iterations",
                     &superansac::DegensacSettings::innerRansacIterations);
  ...
  py::class_<superansac::RANSACSettings>(m, "RANSACSettings")
      ...
      .def_readwrite("local_optimization_settings",
                     &superansac::RANSACSettings::localOptimizationSettings)
      ...
      .def_readwrite("fundamental_orientation_check",
                     &superansac::RANSACSettings::fundamentalOrientationCheck)
      .def_readwrite("fundamental_symmetric_validation",
                     &superansac::RANSACSettings::fundamentalSymmetricValidation)
      .def_readwrite("final_refinement_rounds", &superansac::RANSACSettings::finalRefinementRounds)
      .def_readwrite("final_refinement_schedule",
                     &superansac::RANSACSettings::finalRefinementSchedule)
      .def_readwrite("final_refinement_schedule_start",
                     &superansac::RANSACSettings::finalRefinementScheduleStart)
      .def_readwrite("final_refinement_schedule_end",
                     &superansac::RANSACSettings::finalRefinementScheduleEnd)
      .def_readwrite("final_polish_top_k", &superansac::RANSACSettings::finalPolishTopK)
      .def_readwrite("final_refinement_weighted",
                     &superansac::RANSACSettings::finalRefinementWeighted)
      .def_readwrite("essential_cheirality_point_number",
                     &superansac::RANSACSettings::essentialCheiralityPointNumber)
      .def_readwrite("homography_bundle_refinement",
                     &superansac::RANSACSettings::homographyBundleRefinement)
      .def_readwrite("homography_bundle_max_iterations",
                     &superansac::RANSACSettings::homographyBundleMaxIterations);

  // Expose the function to Python
  m.def(
      "estimateHomography",
      [](py::array_t<double, py::array::c_style> correspondences,
         py::array_t<double, py::array::c_style> image_sizes, py::object probabilities,
        ...
        Eigen::Map<const Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>>
            mat(static_cast<const double*>(buf.ptr), static_cast<Eigen::Index>(buf.shape[0]),
      ...
      py::arg("correspondences"), py::arg("image_sizes"), py::arg("probabilities") = py::none(),
  ...
  m.def(
      ...
      [](py::array_t<double, py::array::c_style> correspondences,
        ...
        // Call the estimator.
        return estimateEssentialMatrix(mat, intrinsics_src_mat, intrinsics_dst_mat, prob_vec,
                                       img_vec, config);
      },
      "A function that performs essential matrix estimation from point correspondences.",
      py::arg("correspondences"), py::arg("intrinsics_src"), py::arg("intrinsics_dst"),
      py::arg("image_sizes"), py::arg("probabilities") = py::none(),
      py::arg("config") = superansac::RANSACSettings());
  ...
  m.def(
      ...
      [](py::array_t<double, py::array::c_style> correspondences,
         py::array_t<double, py::array::c_style> bounding_box_sizes, py::object probabilities,
         superansac::RANSACSettings& config) {
        // Get buffer metadata for correspondences.
        auto buf = correspondences.request();
      ...
      "A function that performs 6D rigid transformation estimation from 3D-3D point "
      "correspondences.",
      py::arg("correspondences"), py::arg("bounding_box_sizes"),
      py::arg("probabilities") = py::none(), py::arg("config") = superansac::RANSACSettings());
  ...
  m.def(
      ...
      [](py::array_t<double, py::array::c_style> correspondences,
         ...
         py::array_t<double, py::array::c_style> bounding_box, py::object probabilities,
         superansac::RANSACSettings& config) {
        // Get buffer metadata for correspondences.
        auto buf = correspondences.request();
      ...
      py::arg("correspondences"), py::arg("camera_type"), py::arg("camera_params"),
      py::arg("bounding_box"), py::arg("probabilities") = py::none(),
      py::arg("config") = superansac::RANSACSettings());
}
